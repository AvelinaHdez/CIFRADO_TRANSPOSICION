...
function encrypt() {
    ...
    document.getElementById("resultado").value = encryptedMessage;
}

function decrypt() {
    const encryptedMessage = document.getElementById("mensaje").value;
    const decryptedMessage = performDecrypt(encryptedMessage);
    document.getElementById("resultado").value = decryptedMessage;
}
